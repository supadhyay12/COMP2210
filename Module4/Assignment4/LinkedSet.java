...
public class LinkedSet<T extends Comparable<T>> implements Set<T> {
    ...
    public boolean add(T element) {
      ...
      if (element.compareTo(temp.element) > 0 && temp == rear) {
            n.prev = temp;
            rear = n;
            temp.next = n;
            size++;
    ...
    public Set<T> union(LinkedSet<T> s){
      ...
      while (fFront != null && nFront != null) {
         ...
         if (fFront.element.compareTo(nFront.element) < 0 && fFront.element.compareTo(nFront.prev.element) > 0) {
            Node temp = new Node(fFront.element);
            temp.next = nFront;
         ...
         if (fFront.element.compareTo(nFront.element) == 0) {
            fFront = fFront.next;
         }
